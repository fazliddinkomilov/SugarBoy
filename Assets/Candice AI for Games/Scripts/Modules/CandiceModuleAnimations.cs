...
namespace CandiceAIforGames.AI
{
    ...
    /*    public ModelImporterAnimationType GetRigType(ModelImporter importer) {
        ...
        public Animator AnimationController() {
            ...
            controller = TemplateAnimator as Animator;

            //check if controller exists
            if (controller == null) {
                //supply new controller
                controller = new Animator();
            }
        ...
        public void AddParameter(Animator controller, string newName, AnimatorControllerParameterType type) {
