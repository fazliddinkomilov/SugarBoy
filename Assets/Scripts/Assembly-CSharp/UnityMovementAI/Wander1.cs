...
namespace UnityMovementAI
{
	...
	public class Wander1 : MonoBehaviour
	{
		...
		public Vector3 GetSteering()
		{
			...
			Vector3 targetPosition = base.transform.position + SteeringBasics.OrientationToVector(rotationInRadians, rb.is3D) * wanderOffset;
			targetPosition += SteeringBasics.OrientationToVector(orientation, rb.is3D) * wanderRadius;
